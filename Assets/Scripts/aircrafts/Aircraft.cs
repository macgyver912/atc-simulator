...
public class Aircraft /*: ScriptableObject*/
{
	 ...
	 * @type {string}
	 */
	private string registration;    // not in use
	/**
	...
	private ushort turnRate;
	private ushort vsRate_Std;
	private ushort vsRate_Max;
	private ushort speedRate_Brake;
	...
	public string GetAircraftModelCode() { return this.aircraftModelCode; }
	public string GetAircraftModelName() { return this.aircraftModelName; }
	public Category GetCategory() { return this.category; }
	public Company GetCompany() { return this.company; }
	public string GetCallsign() { return this.callsign; }
	public string GetCallsignCode() { return this.callsignCode; }
	...
	public Vector2 GetLabelLineOffset() { return this.labelLineOffset; }
	...
	public void SetScreenPosition(Vector3 screenPosition) { this.screenPosition = screenPosition; }
